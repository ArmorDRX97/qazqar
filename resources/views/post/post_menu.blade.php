...
<div class="row justify-content-center g-5">
    ...
    <div class="col-xl-4 col-sm-6">
        <a class="nav-link text-active-primary p-0 {{ (isset($sectionName) && $sectionName == 'openAi') ? 'active' : ''}}"
           href="{{ Auth::user()->hasRole('customer') ? route('customer.post_type',['section' => 'openAi/create']) : route('post_type',['section' => 'openAi/create']) }}">
            <div class="card add-post-card">
                <div class="card-body">
                    <div class="col-lg-12">
                        <div class="item-icon">
