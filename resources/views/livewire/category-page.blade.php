        ...
        <div class="row post-block">
            ...
            <div class="col-lg-7 ps-xl-4">
                <div class="text pt-lg-0 pt-4">
                    ...
                    <p class="short-desc fs-14 text-gray mb-xxl-4 mb-xl-2">
                        {!! $post->description !!}
                    </p>
                    <div class="desc d-flex flex-wrap">
                        <span class="fs-12 text-black">{{ ucfirst(__('messages.common.'.strtolower($post->created_at->format('F')))) }} {{ $post->created_at->format('d, Y') }}</span></span>
                        <span class="fs-12 text-primary mx-2"> | </span>
                        <span class=" fs-12 text-black"> {{ $post->comment->count() }} {{ __('blog.comments') }}</span>
                    </div>
                </div>
            </div>
        </div>
