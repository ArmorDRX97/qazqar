<div class="js-cookie-consent cookie-consent  bottom-0 position-sticky  d-flex align-items-center text-center justify-content-center" style="z-index: 99">
    <div class="max-w-7xl mx-auto px-6">
        <div class="p-2 rounded-lg card" style="box-shadow: 0 0 5px 0 #555">
            <div class="flex items-center justify-between flex-wrap card-body">
                ...
                <div class="mt-2 flex-shrink-0 w-full sm:mt-0 sm:w-auto d-flex justify-content-center">
                    ...
                    <button class="d-flex js-cookie-consent-declined btn btn-danger d-flex align-items-center text-center justify-content-center me-2 p-2 ">
