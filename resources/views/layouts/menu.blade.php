...
@endif
<li class="nav-item {{ Request::is('admin/application-list*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('rental.list') }}">
        <span class="aside-menu-icon pe-3"><i class="fa-solid fa-list-dots fs-3"></i></span>
        <span class="aside-menu-title">{!! __('messages.rental_list') !!}</span>
    </a>
</li>
@can('manage_staff')
    <!--
